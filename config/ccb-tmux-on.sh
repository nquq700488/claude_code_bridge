...
default_status_format_0='#[align=left,bg=#1e1e2e]#{T:status-left}#[align=centre]#{W:#[range=window|#{window_index} fg=#6c7086#,bg=#1e1e2e]  #I:#W  #[norange default],#[range=window|#{window_index} fg=#1e1e2e#,bg=#89b4fa]  #I:#W  #[norange default]}#[align=right]#{T:status-right}'
