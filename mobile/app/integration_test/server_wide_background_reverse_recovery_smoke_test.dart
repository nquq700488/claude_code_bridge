...
void main() {
  ...
  testWidgets(
    'selected-agent refresh survives reverse loss while backgrounded',
    (tester) async {
      if (_projectId.trim().isEmpty) {
        throw TestFailure('background reverse smoke project id is required');
      }
      if (_backgroundSeconds < 3) {
        throw TestFailure('background reverse smoke needs at least 3 seconds');
      }
