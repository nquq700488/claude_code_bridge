...
\begin{enumerate}
  ...
  \item 写入项目配置。用户可以手写 \src{agentroles.archi:codex} 这类 role id shorthand，也可以用 \cmd{ccb roles add agentroles.archi:codex}。后者会寻找最近的项目 \src{.ccb} anchor，并调用 rolepack service 修改项目配置。
