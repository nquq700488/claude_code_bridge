...
```json
{
  ...
  "cleanup_evidence_path": "/home/bfly/yunwei/test_ccb2/phase6-real-lab-l5-partial-only-repeat3-20260704/cleanup/post_b7_cleanup.json",
  ...
  "partial_completed_steps": [
    "- Inspected task packet and execution contract.",
    "- Inspected the existing summary.",
    "- Verified `lab_docs/l5_partial_required_source.md` is absent.",
    "- Updated the summary to record `status: partial`, missing source status, completed steps, and unfinished steps."
  ],
  "partial_observed": false,
  "partial_reason": "# Partial Evidence\n\nThe worker produced a partial signal:\n\n- status: needs_rework\n- bounded result: partial\n- required source file absent: `lab_docs/l5_partial_required_source.md`\n- edited file: `lab_docs/l5_partial_existing_summary.md`\n\nThis partial signal is not reviewer-gated. Reviewer submission failed before any reviewer verdict existed, so the supervised run remains blocked and not claimable.",
  "partial_unfinished_steps": [
    "- Source synchronization remains incomplete until `lab_docs/l5_partial_required_source.md` exists.",
    "- Reviewer-gated partial observation remains incomplete because reviewer submission failed."
  ],
